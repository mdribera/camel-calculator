...
console.log(calculateOdds(mockData['sample-situation']));
...
// console.log('total roll combos', getAllDieCombos(mockData['sample-situation'].camels).length);
...
function getAllDieCombos(camels) {
    ...
    console.log('die order length', diceOrders.length);
